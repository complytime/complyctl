...
| `COMPLYTIME_SYSTEM_PROVIDER_DIR` | Override the system-wide provider directory scanned after the user provider directory (default: `/usr/libexec/complytime/providers`) |
